...
public class exercise3 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(exercise3.class.getName());
    ...
    private void initComponents() {
        ...
        setTitle("Exit App Window");
        setSize(300, 200);
        setLocationRelativeTo(null);

        javax.swing.JButton btnExit = new javax.swing.JButton("Exit");
        btnExit.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
